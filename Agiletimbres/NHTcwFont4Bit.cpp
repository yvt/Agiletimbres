...
#include "NHTcwFont4Bit.h"
#include <tcw/twSDLDC.h>

NHTcwFont4Bit::NHTcwFont4Bit(unsigned char *fontData, unsigned int *indexMap, unsigned char *widthMap)
...
void NHTcwFont4Bit::drawBlock(twSDLDC *dc, uint16_t color, twPoint pt, const unsigned char *data) const{
...
void NHTcwFont4Bit::drawGlyph(twSDLDC *dc, uint16_t color, twPoint pt, uint16_t chr) const{
...
void NHTcwFont4Bit::bitmapForGlyph(uint8_t *glyphBuf, uint16_t chr) const{
...
void NHTcwFont4Bit::placeBlock(uint8_t *dest, size_t pitch,
